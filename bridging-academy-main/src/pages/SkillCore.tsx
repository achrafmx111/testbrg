...
import { 
  ...
  Filter, ChevronDown, GraduationCap, Target, Users, Briefcase 
} from 'lucide-react';
...
const courses = [
  {
    ...
    duration: 6,
    language: 'de',
    description: 'Verstehe die Grundlagen von SAP S/4HANA und die zentralen Geschäftsprozesse.',
    outcomes: ['SAP Architektur verstehen', 'S/4HANA Navigation', 'Kernmodule im Überblick'],
    certification: true,
  },
  {
    id: 2,
    slug: 'fico',
    title: 'SAP FI/CO Komplettkurs',
    category: 'core',
    level: 'intermediate',
    duration: 10,
    language: 'de',
    description: 'Umfassende Ausbildung in Finanzwesen und Controlling.',
    outcomes: ['Hauptbuchhaltung', 'Kostenstellenrechnung', 'Reporting & Analyse'],
    certification: true,
  },
  {
    id: 3,
    slug: 'mm',
    title: 'SAP MM – Materialwirtschaft',
    category: 'core',
    level: 'intermediate',
    duration: 8,
    language: 'de',
    description: 'Beschaffung und Bestandsführung in SAP meistern.',
    outcomes: ['Beschaffungsprozesse', 'Bestandsführung', 'Lieferantenmanagement'],
    certification: true,
  },
  {
    id: 4,
    ...
    duration: 12,
    language: 'de',
    description: 'Praxisnahe SAP BTP Ausbildung mit integriertem Projekt und Internship – powered by Realcore.',
    outcomes: ['Cloud Integration', 'Extension Development', 'Platform Services'],
    certification: true,
    premium: true,
  },
  {
    id: 5,
    slug: 'abap',
    title: 'ABAP Programmierung für Einsteiger',
    category: 'development',
    level: 'beginner',
    duration: 12,
    language: 'de',
    description: 'Starte deine Karriere als SAP-Entwickler mit ABAP.',
    outcomes: ['ABAP Syntax', 'Report Programmierung', 'Datenbankoperationen'],
    certification: true,
  },
  {
    id: 6,
    slug: 's4hana-migration',
    title: 'S/4HANA Migrationsspezialist',
    category: 'transformation',
    level: 'advanced',
    duration: 10,
    language: 'de',
    description: 'Führe S/4HANA Transformationsprojekte in Unternehmen.',
    outcomes: ['Migrationsstrategien', 'Brownfield vs Greenfield', 'Projektmanagement'],
    certification: true,
  },
  {
    id: 7,
    ...
    duration: 6,
    language: 'de',
    description: 'Datenvisualisierung und Business Intelligence mit SAP Analytics Cloud.',
    outcomes: ['Dashboard-Erstellung', 'Predictive Analytics', 'Story Building'],
    certification: true,
  },
  {
    id: 8,
    slug: 'rap',
    title: 'RAP – ABAP RESTful Programmierung',
    category: 'development',
    level: 'advanced',
    duration: 8,
    language: 'de',
    description: 'Moderne SAP-Entwicklung mit dem RESTful Application Programming Modell.',
    outcomes: ['RAP Architektur', 'Fiori Integration', 'OData Services'],
    certification: true,
  },
];
