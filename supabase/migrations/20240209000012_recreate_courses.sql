-- Recreate Courses Table and Seed Data
-- Run this to fix "Select Course" empty issue
...
ON CONFLICT (slug) DO UPDATE SET
    ...
    category_label_de = EXCLUDED.category_label_de,
    level = EXCLUDED.level,
    level_de = EXCLUDED.level_de,
    duration = EXCLUDED.duration,
    duration_de = EXCLUDED.duration_de,
    language = EXCLUDED.language,
    description = EXCLUDED.description,
    description_de = EXCLUDED.description_de,
    hero_subtitle = EXCLUDED.hero_subtitle,
    hero_subtitle_de = EXCLUDED.hero_subtitle_de,
    learning_outcomes = EXCLUDED.learning_outcomes,
    curriculum = EXCLUDED.curriculum,
    target_audience = EXCLUDED.target_audience,
    highlights = EXCLUDED.highlights,
    highlights_de = EXCLUDED.highlights_de,
