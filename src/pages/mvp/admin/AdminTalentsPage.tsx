...
import { Loader2, UserCheck, X, User, Award, BookOpen, Globe, Star, Briefcase } from "lucide-react";
...
export default function AdminTalentsPage() {
  ...
  return (
    <div className={adminClassTokens.pageShell}>
      ...
      {talents.length === 0 ? <AdminEmptyState text="No talents found yet. Talents will appear here after registering through the Talent Pool." /> : null}
